    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="/login" class="mr-2 text-gray-600 font-semibold hover:text-gray-800">Login</a>
                    <a href="/register" class="text-gray-600 font-semibold hover:text-gray-800">Register</a>
                @endauth
            </div>
